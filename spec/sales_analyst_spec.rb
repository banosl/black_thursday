...
RSpec.describe SalesAnalyst do
  ...
  context 'create invoice' do
    ...
    it 'totals revenue by merchant' do
      ...
      expect(sales_analyst.revenue_by_merchant(12_334_160)).to be_a(BigDecimal)
    end

    it '#most_sold_item_for_merchant' do
      sales_analyst = @sales_engine.analyst
      expect(sales_analyst.most_sold_item_for_merchant(12_334_105)).to be_a(Array)
      expect(sales_analyst.most_sold_item_for_merchant(12_334_105)[0]).to be_instance_of(Item)
      expect(sales_analyst.most_sold_item_for_merchant(12_334_105)[0].id).to eq(263_541_512)
    end
    ...
    it '#best_item_for_merchant' do
      sales_analyst = @sales_engine.analyst
      expect(sales_analyst.best_item_for_merchant(12_334_496)).to be_instance_of(Item)
      expect(sales_analyst.best_item_for_merchant(12_334_496).id).to eq(263_524_340)
      expect(sales_analyst.best_item_for_merchant(12_337_341).id).to eq(263_431_343)
      expect(sales_analyst.best_item_for_merchant(12_335_254).id).to eq(263_535_488)
    end
  end
end
